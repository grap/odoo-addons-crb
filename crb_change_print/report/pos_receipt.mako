...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    %for pos_order in objects :
        ...
        <table class="sale_details">
            ...
            <tr>
                <td colspan="2" class="quantity_text">
                ${pos_order_line.qty} x ${pos_order_line.price_unit}&nbsp;${company.currency_id.symbol}
            <tr>
            %endif
            %if pos_order_line.discount:
            <tr>
                <td colspan="2" class="discount_text">
                (- ${pos_order_line.discount}&nbsp;% 
                soit - ${ "%.2f" % (pos_order_line.discount*pos_order_line.price_unit*pos_order_line.qty/100)}&nbsp;${company.currency_id.symbol})
            <tr>
            %endif
